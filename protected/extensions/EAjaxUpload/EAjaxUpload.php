...
class EAjaxUpload extends CWidget
{
	...
	public $css=null;
		...
		Yii::app()->clientScript->registerScriptFile($baseUrl . '/imageselect/jquery.imgareaselect.js', CClientScript::POS_HEAD);

                $this->css=(!empty($this->css))?$this->css:$baseUrl.'/fileuploader.css';
                Yii::app()->clientScript->registerCssFile($this->css);
				
				
                Yii::app()->clientScript->registerCssFile($baseUrl . '/imageselect/css/imgareaselect-animated.css');
