...
//      $mcFileManagerConfig['general.tools'] = "upload";
...
//	$mcFileManagerConfig['filesystem.rootpath'] = '/var/www/financial_buzz_new/videos'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.path'] = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) .'/videos';
        
        $mcFileManagerConfig['filesystem.rootpath'] = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) .'/videos';
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv, mp4";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,mpeg,mpg";
