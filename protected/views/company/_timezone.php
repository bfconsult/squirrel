<h4><?php echo Yii::App()->params['timezone']  ?></h4>
<?php 
	$metaData = $model->getEavAttributes(array('timezone'));
	$timezone = '';
...
<div class="span9">
	<form class="form-horizontal" id="user-form" action="<?php echo Yii::app()->createUrl('company/addmeta'); ?>" method="post">
		...
		<label class="control-label" for="Companymetaform_timezone"><?php echo Yii::App()->params['timezone']  ?></label>
		<div class="controls">
		<?php
		echo CHtml::dropDownList('Companymetaform[timezone]', $timezone,
                        array (
                        'Africa' => array (
		...
		<div class="control-group pull-right">
			<div class="controls">
			 	<button type="submit" class="btn"><?php echo Yii::t('app','Update'); ?></button>
			</div>
		</div>
	</form>
</div>